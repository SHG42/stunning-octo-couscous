...
openit.onload = function doRegionOverlay() {
      document.getElementById("regionOverlayBox");
      document.getElementById("regionOverlayBox").style.display="block";
    }
...
closeit.onclick = function doCloseOverlay() {
    document.getElementById("regionOverlayBox");
    document.getElementById("regionOverlayBox").style.display="none";
...
function switchBG(launchPopup) {
  ...
  switch (x) {//pass x into the switch statement because it contains the background image source retrieved from our div element.
    case 'Arctic':
      ...
      popupBG.style.backgroundColor = "white";
      break;
    case 'Desert':
      popupHeader.innerHTML = desertHeader;
      popupBG.style.backgroundColor = "yellow";
      break;
    case 'Swamp':
      popupHeader.innerHTML = swampHeader;
      popupBG.style.backgroundColor = "grey";
      break;
    case 'Forest':
      popupHeader.innerHTML = forestHeader;
      popupBG.style.backgroundColor = "green";
      break;
    case 'Savannah':
      popupHeader.innerHTML = savannahHeader;
      popupBG.style.backgroundColor = "red";
      break;
    case 'Mountains':
      popupHeader.innerHTML = mountainsHeader;
      popupBG.style.backgroundColor = "blue";
      break;
    default:
      return false;
  }//NAILED IT!!!!!
